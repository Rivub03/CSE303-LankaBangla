...
<?php
    ...
    $sql = "INSERT INTO jointaccountholder (Title, Name, FatherName, MotherName, Presentaddress, Mobile, Email, Etin, NID, DateofBirth, Occupation, Gender, Nationality, Residency, Declaration)
