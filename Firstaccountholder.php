...
<body>
    <div class="container mt-5">
        <h2 class="mb-4">Customer Account Information Form(First Account Holder)</h2>
...
<?php
    ...
    $sql = "INSERT INTO firstaccountholder (Title, Name, FatherName, MotherName, Presentaddress, Mobile, Email, Etin, NID, DateofBirth, Occupation, Gender, Nationality, Residency, Declaration)
