...
<div>
        ...
        <label for="declaration">It is hereby declared that all the above mentioned information BO account first applicant information form are true and valid</label>
...
<?php
    ...
    $sql = "INSERT INTO boaccountfirstapplicant (BOID ,  Title, Name, FatherName, MotherName, Presentaddress, Mobile, Email, Etin, NID, DateofBirth, Occupation, Gender, Nationality, Residency, Declaration)
