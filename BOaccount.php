...
<p>All transactions shall be subject to the Rules and Regulations of the Securities and Exchange Commission of Bangladesh, Dhaka 
Stock Exchange Ltd. and other prevailing laws and regulations of Bangladesh and in particular the authority.After granted by the client to the BROKER</p>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
  ...
  <!-- Signature field for the CLIENT(s) -->
  <label for="clientSignature">Signature of CLIENT(s):</label>
  ...
  <button type="button" class="nav-link btn btn-success" onclick="goToBOAccount()">BO Account Form</button>
...
<script>
        ...
        function goToBOAccount(){

            window.location.href = "BOaccountform.php";
