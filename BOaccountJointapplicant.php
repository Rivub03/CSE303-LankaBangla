...
<html>
<head>
    <title>Depository Account Application</title>
...
<body>
    ...
    <div class="container">
        <h1 class="mt-4">Depository Account Application</h1>
        
        <form action="process_application.php" method="post">
            <!-- First Applicant -->
            <div class="form-section">
                <h2 class="mt-4">Joint Applicant</h2>
                ...
                <div class="form-group">
                    <label for="accountHolderFullName">BO ID:</label>
                    <input type="text" class="form-control" id="accountHolderFullName" name="accountHolderFullName">
                </div>
        ...
        <form action="process_application.php" method="post">
            <!-- First Applicant -->
            <div class="form-section">
                <h2 class="mt-4">First Applicant</h2>
                
                
            
            
                <div class="form-group">
                    <label for="BOID">BO ID:</label>
                    <input type="text" class="form-control" id="BOID" name="BOID">
                </div>
...
<div>
        ...
        <label for="declaration">It is hereby declared that all the above mentioned information in BO account joint applicant information form are true and valid</label>
...
<?php
    ...
    $sql = "INSERT INTO boaccountjointapplicant (BOID ,  Title, Name, FatherName, MotherName, Presentaddress, Mobile, Email, Etin, NID, DateofBirth, Occupation, Gender, Nationality, Residency, Declaration)
    VALUES ('$BOID', $title', '$name', '$fatherName', '$motherName', '$presentAddress', '$mobile', '$email', '$etin', '$nid', '$dateOfBirth', '$occupation', '$gender', '$nationality', '$residency', '$declaration')";
