...
<body>
    ...
    <h2 class="mb-4">Customer Account Information Form(Authorized Person Information)</h2>
...
<div>
        ...
        <label for="declaration">It is hereby declared that all the above mentioned information in customer account information form are true and valid</label>
...
<?php
    ...
    $sql = "INSERT INTO authorizedpersoninformation (Title, Name, FatherName, MotherName, Presentaddress, Mobile, Email, Etin, NID, DateofBirth, Occupation, Gender, Nationality, Residency, Declaration)
    VALUES ('$title', '$name', '$fatherName', '$motherName', '$presentAddress', '$mobile', '$email', '$etin', '$nid', '$dateOfBirth', '$occupation', '$gender', '$nationality', '$residency', '$declaration')";
